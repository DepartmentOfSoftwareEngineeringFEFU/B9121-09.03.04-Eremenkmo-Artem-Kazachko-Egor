...
function StepAnalysis() {
    ...
    const mockStepData = {
        ...
        recommendations: "Предложить пользователям больше подсказок и упростить задание."
    };
